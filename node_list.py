...
class NodeList(tk.Frame):
    ...
    def __init__(self, parent, callbacks, *args, **kwargs):
        ...
        self.treeview.bind('<Double-1>', self.on_open_record)
        self.treeview.bind('<<TreeviewSelect>>', self.on_select_record)
    ...
    def on_open_record(self, *args):
        ...
        print(f"on_open_record: {str(selected_id)}")

    def on_select_record(self, *args):
        selected_id = self.treeview.selection()[0]
        # self.callbacks['on_open_record'][selected_id]
        print(f"on_select_record: {str(selected_id)}")
